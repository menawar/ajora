...
/// @notice Deploys the Ajora core (PotVault + StreakSBT) against a Mento stablecoin and wires them.
...
contract Deploy is Script {
    function run() external returns (PotVault vault, StreakSBT streak) {
