...
export const en = {
  ...
  "home.status": "You have <strong>{{tickets}}</strong> tickets · <strong>{{balance}} USDm</strong> saved today (always withdrawable)",
  ...
  "save.amountPlaceholder": "Amount in USDm (min 0.10)",
  "save.balance": "Balance: {{balance}} USDm",
  "save.tickets": "+{{tickets}} tickets",
  "save.tooSmall": "Amount too small (min 0.10)",
  "save.insufficient": "Insufficient USDm",
  "save.approving": "Approving USDm...",
  "save.saving": "Saving to Celo...",
  "save.submit": "Save {{amount}} USDm",
...
const pcm: Dictionary = {
  ...
  "home.status": "[PCM] You have <strong>{{tickets}}</strong> tickets · <strong>{{balance}} USDm</strong> saved today (always withdrawable)",
  ...
  "save.amountPlaceholder": "[PCM] Amount in USDm (min 0.10)",
  "save.balance": "[PCM] Balance: {{balance}} USDm",
  "save.tickets": "[PCM] +{{tickets}} tickets",
  "save.tooSmall": "[PCM] Amount too small (min 0.10)",
  "save.insufficient": "[PCM] Insufficient USDm",
  "save.approving": "[PCM] Approving USDm...",
  "save.saving": "[PCM] Saving to Celo...",
  "save.submit": "[PCM] Save {{amount}} USDm",
...
const sw: Dictionary = {
  ...
  "home.status": "[SW] You have <strong>{{tickets}}</strong> tickets · <strong>{{balance}} USDm</strong> saved today (always withdrawable)",
  ...
  "save.amountPlaceholder": "[SW] Amount in USDm (min 0.10)",
  "save.balance": "[SW] Balance: {{balance}} USDm",
  "save.tickets": "[SW] +{{tickets}} tickets",
  "save.tooSmall": "[SW] Amount too small (min 0.10)",
  "save.insufficient": "[SW] Insufficient USDm",
  "save.approving": "[SW] Approving USDm...",
  "save.saving": "[SW] Saving to Celo...",
  "save.submit": "[SW] Save {{amount}} USDm",
...
const fr: Dictionary = {
  ...
  "home.status": "Vous avez <strong>{{tickets}}</strong> tickets · <strong>{{balance}} USDm</strong> épargnés aujourd'hui (toujours retirables)",
  ...
  "save.amountPlaceholder": "Montant en USDm (min 0.10)",
  "save.balance": "Solde: {{balance}} USDm",
  "save.tickets": "+{{tickets}} tickets",
  "save.tooSmall": "Montant trop petit (min 0.10)",
  "save.insufficient": "USDm insuffisant",
  "save.approving": "Approbation USDm...",
  "save.saving": "Sauvegarde sur Celo...",
  "save.submit": "Épargner {{amount}} USDm",
...
const es: Dictionary = {
  ...
  "home.status": "Tienes <strong>{{tickets}}</strong> boletos · <strong>{{balance}} USDm</strong> ahorrados hoy (siempre retirables)",
  ...
  "save.amountPlaceholder": "Monto en USDm (mín 0.10)",
  "save.balance": "Saldo: {{balance}} USDm",
  "save.tickets": "+{{tickets}} boletos",
  "save.tooSmall": "Monto demasiado pequeño (mín 0.10)",
  "save.insufficient": "USDm insuficiente",
  "save.approving": "Aprobando USDm...",
  "save.saving": "Guardando en Celo...",
  "save.submit": "Ahorrar {{amount}} USDm",
