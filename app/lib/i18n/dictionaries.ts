...
// Swahili ship first — the primary Freighter audiences. Add keys to `en`, then fill
...
export const en = {
  ...
  "nav.crew": "Crew",
  "nav.wallet": "Wallet",
  "home.tagline": "Save small, keep every cent, win extra bonus.",
  "home.faqLink": "How is my money safe?",
  "home.cta.save": "Start Saving",
  "home.cta.draw": "View Draw",
  "home.status": "You have <strong>{{tickets}}</strong> tickets · <strong>{{balance}} USDC</strong> saved today (always withdrawable)",
  ...
  "save.amountPlaceholder": "Amount in USDC (min 0.10)",
  "save.balance": "Balance: {{balance}} USDC",
  "save.tickets": "+{{tickets}} tickets",
  "save.tooSmall": "Amount too small (min 0.10)",
  "save.insufficient": "Insufficient USDC",
  "save.approving": "Approving USDC...",
  "save.saving": "Saving to Stellar...",
  "save.submit": "Save {{amount}} USDC",
...
const pcm: Dictionary = {
  ...
  "nav.crew": "Crew",
  "nav.wallet": "Wallet",
  "home.tagline": "Save small small, keep your money, win extra bonus.",
  "home.faqLink": "[PCM] How is my money safe?",
  "home.cta.save": "[PCM] Start Saving",
  "home.cta.draw": "[PCM] View Draw",
  "home.status": "[PCM] You have <strong>{{tickets}}</strong> tickets · <strong>{{balance}} USDC</strong> saved today (always withdrawable)",
  ...
  "save.amountPlaceholder": "[PCM] Amount in USDC (min 0.10)",
  "save.balance": "[PCM] Balance: {{balance}} USDC",
  "save.tickets": "[PCM] +{{tickets}} tickets",
  "save.tooSmall": "[PCM] Amount too small (min 0.10)",
  "save.insufficient": "[PCM] Insufficient USDC",
  "save.approving": "[PCM] Approving USDC...",
  "save.saving": "[PCM] Saving to Stellar...",
  "save.submit": "[PCM] Save {{amount}} USDC",
...
const sw: Dictionary = {
  ...
  "nav.crew": "Kikundi",
  "nav.wallet": "Pochi",
  "home.tagline": "Weka kidogo, tunza kila senti, win extra bonus.",
  "home.faqLink": "[SW] How is my money safe?",
  "home.cta.save": "[SW] Start Saving",
  "home.cta.draw": "[SW] View Draw",
  "home.status": "[SW] You have <strong>{{tickets}}</strong> tickets · <strong>{{balance}} USDC</strong> saved today (always withdrawable)",
  ...
  "save.amountPlaceholder": "[SW] Amount in USDC (min 0.10)",
  "save.balance": "[SW] Balance: {{balance}} USDC",
  "save.tickets": "[SW] +{{tickets}} tickets",
  "save.tooSmall": "[SW] Amount too small (min 0.10)",
  "save.insufficient": "[SW] Insufficient USDC",
  "save.approving": "[SW] Approving USDC...",
  "save.saving": "[SW] Saving to Stellar...",
  "save.submit": "[SW] Save {{amount}} USDC",
...
const fr: Dictionary = {
  ...
  "home.status": "Vous avez <strong>{{tickets}}</strong> tickets · <strong>{{balance}} USDC</strong> épargnés aujourd'hui (toujours retirables)",
  ...
  "save.amountPlaceholder": "Montant en USDC (min 0.10)",
  "save.balance": "Solde: {{balance}} USDC",
  "save.tickets": "+{{tickets}} tickets",
  "save.tooSmall": "Montant trop petit (min 0.10)",
  "save.insufficient": "USDC insuffisant",
  "save.approving": "Approbation USDC...",
  "save.saving": "Sauvegarde sur Stellar...",
  "save.submit": "Épargner {{amount}} USDC",
...
const es: Dictionary = {
  ...
  "home.status": "Tienes <strong>{{tickets}}</strong> boletos · <strong>{{balance}} USDC</strong> ahorrados hoy (siempre retirables)",
  ...
  "save.amountPlaceholder": "Monto en USDC (mín 0.10)",
  "save.balance": "Saldo: {{balance}} USDC",
  "save.tickets": "+{{tickets}} boletos",
  "save.tooSmall": "Monto demasiado pequeño (mín 0.10)",
  "save.insufficient": "USDC insuficiente",
  "save.approving": "Aprobando USDC...",
  "save.saving": "Guardando en Stellar...",
  "save.submit": "Ahorrar {{amount}} USDC",
