...
export function AgnesWidget022({ id = "AgnesWidget022", title = "AgnesWidget022 Widget", status = 'active', onAction }: AgnesWidget022Props) {
  ...
  return (
    <div id={id} data-testid="AgnesWidget022-container" className="p-4 rounded-xl border border-gray-200 bg-white shadow-sm flex items-center justify-between transition-shadow hover:shadow-md">
      <div>
      ...
      {onAction && (
        <button data-testid="AgnesWidget022-btn" onClick={handleClick} disabled={loading} className="px-3 py-1.5 text-xs font-medium bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50">
