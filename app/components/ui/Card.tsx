  ...
  ({ className = "", variant = "default", interactive = false, children, ...props }, ref) => {
    return (
      <motion.div
        ...
        className={`rounded-2xl p-4 sm:p-5 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-Stellar-green focus-visible:ring-offset-2 ${interactive ? "cursor-pointer hover:shadow-lg" : ""} ${variantStyles[variant]} ${className}`}
