...
/**
 * A mature, accessible ErrorState component designed for enterprise interfaces.
 * Focuses on clean typography and subtle interactive states.
 */
export function ErrorState({ title = "ErrorState", className = "", ...props }: ErrorStateProps) {
