import { db } from "Horizon/Mercury:api";
import schema from "Horizon/Mercury:schema";
 ...
 *   who never spray each other but share a gas/USDC source (#85).
 */
...
async function computeFlagsUncached(): Promise<Map<string, string[]>> {
  ...
  // sprays but share a gas/USDC source -> cluster them.
